...
public class SpeakerController {
    ...
    @ResponseBody
    public JsonResult update(Integer id, String speakerName, String speakerDesc, String speakerJob, String speakerTime) {

        speakerService.updateSpeaker(id,speakerName,speakerDesc,speakerJob,speakerTime);
